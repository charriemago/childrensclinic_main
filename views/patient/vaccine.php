                            ...
                            <table class="table table-pad table-striped table-hover table-standard">
                                ...
                                <tbody>
                                    <?php foreach ($vaccines as $key => $vaccine) : ?>
                                        ...
                                        <?php
                                            $i1st = $immune[0]['1st'] != '' ? explode(" ",$immune[0]['1st']) : '';
                                            $i2nd = $immune[0]['2nd'] != '' ? explode(" ",$immune[0]['2nd']) : '';
                                            $i3rd = $immune[0]['3rd'] != '' ? explode(" ",$immune[0]['3rd']) : '';
                                            $Booster1 = $immune[0]['Booster_1'] != '' ? explode(" ",$immune[0]['Booster_1']) : '';
                                            $Booster2 = $immune[0]['Booster_2'] != '' ? explode(" ",$immune[0]['Booster_2']) : '';
                                            $Booster3 = $immune[0]['Booster_3'] != '' ? explode(" ",$immune[0]['Booster_3']) : '';
                                        ?>
                                        <tr>
