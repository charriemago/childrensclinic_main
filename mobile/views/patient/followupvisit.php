                        ...
                        <tbody>
                            <?php foreach ($visit as $key => $v) : ?>
                                ...
                                <tr>
                                    ...
                                    <td><input class="form-control" type="number" placeholder="kg" name="weight[]" value="<?= $v['weight']?>"></td>      
                                    <td><input class="form-control" type="number" placeholder="cm" name="height[]" value="<?= $v['height']?>"></td>      
